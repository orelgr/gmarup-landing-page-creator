          ...
          <div className="lg:w-5/12">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="flex flex-col gap-6">
                <a 
                  href="mailto:gmarupil@gmail.com"
                  className="flex items-center gap-3 text-gmarup-blue hover:text-gmarup-turquoise transition-colors"
                >
                ...
                <div className="mt-4">
                  ...
                  <a 
                    href="https://chat.whatsapp.com/LNmVCXvv35S9SsbWTol2qW"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gmarup-blue focus:outline-none"
                  required
                />
              </div>
              ...
              <div className="mb-6">
                <div className="h-10 bg-gray-100 flex items-center justify-center rounded-lg">
                  <p className="text-gray-500 text-sm">reCAPTCHA שדה</p>
                </div>
              </div>
