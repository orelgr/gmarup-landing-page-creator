...
const Hero = () => {
  return <section className="relative min-h-[90vh] md:min-h-[80vh] flex items-center overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-amber-100 to-amber-700 opacity-90 my-[34px]"></div>
